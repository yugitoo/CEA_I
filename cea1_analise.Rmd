...
## Modelagem (Arquivo modelagem enviado dia 20/06/2021)
### Bibliotecas
```{r}
## Modelagem 
library(glmm)
...
Usando o stepAIC parece que a modelagem por femea nao foi modelada (?)
```{r}
stepAIC(ajuste1)
```
...
##### Modelagem Estagio I - # matriz de covariancia e variancia (Sigma)
```{r}
vcov(ajuste1) # matriz de covariancia e variancia (Sigma)
```

##### algumas coisas que eu nao sei
```{r}
